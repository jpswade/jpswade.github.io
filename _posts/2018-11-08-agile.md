...
## Warnings
If you’re already skeptical of agile, perhaps it's because you’ve heard about when it does go wrong and it can, if you get it wrong.

I've seen and heard all sorts of anti-patterns, common mistakes and general pitfalls, so agile does come with some warnings...
...
- A stand-up meeting is called that because it should be short so you don’t get fed up of standing. If you are standing up too long, perhaps you have too many stories in flight, stories are too complex and should be broken down or perhaps the people are talking about other things rather than the stories.
- Don’t fall into the trap of thinking that story points to measure progress. Don't waste too much time over-thinking estimates, they are just estimates. Its a guide to help you keep moving forward. Remember, outcomes are what matter.
...
- Don’t get too bogged down in the detail. You can fall into the trap of becoming too scientific about story points and velocity, it’s unnecessary.
...
## Measuring
When we think abut our success, we often think about measuring our processes. How fast our builds run, how long our tests take, how many bugs we have, how many fatal errors there are in production, what our availability is, our time to recovery, how performant our application platform is, how much test coverage our code.
