...
In this example I'm going to use [Sebastian Bergmann's Money](https://github.com/sebastianbergmann/money) project.

So we need to tell git to go checkout the code first...
...
At it's very basics, this is all we need it to do for now. Let's get this into action...

We'll run our docker by using the following:
